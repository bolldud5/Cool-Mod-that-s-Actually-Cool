...
import net.mcreator.coolmodthatsactuallycool.procedures.DesertWalkerOnInitialEntitySpawnProcedure;
import net.mcreator.coolmodthatsactuallycool.procedures.DesertWalkerOnEntityTickUpdateProcedure;
