...
public class Huge3GreenMushroomStructure extends CoolModThatsActuallyCoolModElements.ModElement {
	public Huge3GreenMushroomStructure(CoolModThatsActuallyCoolModElements instance) {
		super(instance, 29);
	}
