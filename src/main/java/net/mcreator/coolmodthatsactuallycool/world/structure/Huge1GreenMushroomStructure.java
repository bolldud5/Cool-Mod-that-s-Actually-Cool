...
public class Huge1GreenMushroomStructure extends CoolModThatsActuallyCoolModElements.ModElement {
	public Huge1GreenMushroomStructure(CoolModThatsActuallyCoolModElements instance) {
		super(instance, 27);
	}
